...
class Restaurant_action_list_9180930133bd75d4c9b40d73267834586ca7ed51 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments5['key'] = 'tx_hofexpressapp_domain_model_restaurant.restaurant_type';
...
$array15 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('restaurant.name', $array15)]);
};
$arguments11 = array();
...
$array13 = array();
$array14 = array (
);$array13['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array14);
...
$array20 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('restaurant.restaurantType', $array20)]);
};
$arguments16 = array();
...
$array18 = array();
$array19 = array (
);$array18['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array19);
...
$array23 = array();
$array24 = array (
);$array23['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array24);
...
$array9 = array (
);$arguments7['each'] = $renderingContext->getVariableProvider()->getByPath('restaurants', $array9);
$arguments7['as'] = 'restaurant';
...
$arguments39['key'] = 'tx_hofexpressapp_domain_model_restaurant.name';
...
$arguments41['key'] = 'tx_hofexpressapp_domain_model_restaurant.restaurant_type';
...
$array51 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('restaurant.name', $array51)]);
};
$arguments47 = array();
...
$array49 = array();
$array50 = array (
);$array49['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array50);
...
$array56 = array (
);return call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('restaurant.restaurantType', $array56)]);
};
$arguments52 = array();
...
$array54 = array();
$array55 = array (
);$array54['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array55);
...
$array59 = array();
$array60 = array (
);$array59['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array60);
...
$array63 = array();
$array64 = array (
);$array63['restaurant'] = $renderingContext->getVariableProvider()->getByPath('restaurant', $array64);
...
$array45 = array (
);$arguments43['each'] = $renderingContext->getVariableProvider()->getByPath('restaurants', $array45);
$arguments43['as'] = 'restaurant';
