...
class Standard_action_PageZero_cbda8086e6284658f9774437db667add06801cde extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array458 = array();
$array459 = array (
);$array458['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('template.root', $array459)]);
...
$array471['0'] = '!';
$array472 = array (
);$array471['1'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('template.root', $array472)]);
