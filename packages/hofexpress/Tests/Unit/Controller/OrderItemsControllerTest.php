...
{
    /**
     * @var \Hulk\Hofexpress\Controller\OrderItemsController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Hulk\Hofexpress\Controller\OrderItemsController::class)
    ...
    public function listActionFetchesAllOrderItemssFromRepositoryAndAssignsThemToView()
    {
        ...
        $orderItemsRepository = $this->getMockBuilder(\::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $orderItems = new \Hulk\Hofexpress\Domain\Model\OrderItems();
