...
class OrderTest extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
    ...
    {
        parent::setUp();
        $this->subject = new \Hulk\HofexpressApp\Domain\Model\Order();
    }
    ...
    {
        $orderStatusFixture = new \Hulk\HofexpressApp\Domain\Model\OrderStatus();
    ...
    {
        $deliveryFixture = new \Hulk\HofexpressApp\Domain\Model\DeliveryType();
    ...
    {
        $customerFixture = new \Hulk\HofexpressApp\Domain\Model\Customer();
