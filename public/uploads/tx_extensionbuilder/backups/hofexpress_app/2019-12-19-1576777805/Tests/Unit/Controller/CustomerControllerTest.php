...
{
    /**
     * @var \Hulk\HofexpressApp\Controller\CustomerController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Hulk\HofexpressApp\Controller\CustomerController::class)
    ...
    public function listActionFetchesAllCustomersFromRepositoryAndAssignsThemToView()
    {
        ...
        $customerRepository = $this->getMockBuilder(\Hulk\HofexpressApp\Domain\Repository\CustomerRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $customer = new \Hulk\HofexpressApp\Domain\Model\Customer();
