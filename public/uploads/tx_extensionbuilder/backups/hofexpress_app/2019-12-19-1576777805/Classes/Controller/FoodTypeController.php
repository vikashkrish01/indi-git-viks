...
class FoodTypeController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * foodTypeRepository
     * 
     * @var \Hulk\HofexpressApp\Domain\Repository\FoodTypeRepository
     */
    ...
    /**
     * @param \Hulk\HofexpressApp\Domain\Repository\FoodTypeRepository $foodTypeRepository
     */
    public function injectFoodTypeRepository(\Hulk\HofexpressApp\Domain\Repository\FoodTypeRepository $foodTypeRepository)
    {
     ...
     * @return void
     */
    public function showAction(\Hulk\HofexpressApp\Domain\Model\FoodType $foodType)
    {
        $this->view->assign('foodType', $foodType);
    }
}
