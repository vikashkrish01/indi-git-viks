...
class OrderStatusController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * 
     * @var \Hulk\HofexpressApp\Domain\Repository\OrderStatusRepository
     */
    ...
    /**
     * @param \Hulk\HofexpressApp\Domain\Repository\OrderStatusRepository $orderStatusRepository
     */
    public function injectOrderStatusRepository(\Hulk\HofexpressApp\Domain\Repository\OrderStatusRepository $orderStatusRepository)
    {
     ...
     * action show
     * 
     * @param \Hulk\HofexpressApp\Domain\Model\OrderStatus $orderStatus
     * @return void
     */
    public function showAction(\Hulk\HofexpressApp\Domain\Model\OrderStatus $orderStatus)
    {
        $this->view->assign('orderStatus', $orderStatus);
    }
}
