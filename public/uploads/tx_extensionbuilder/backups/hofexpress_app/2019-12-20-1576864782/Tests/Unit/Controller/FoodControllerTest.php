...
{
    /**
     * @var \Hulk\HofexpressApp\Controller\FoodController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Hulk\HofexpressApp\Controller\FoodController::class)
    ...
    public function listActionFetchesAllFoodsFromRepositoryAndAssignsThemToView()
    {
        ...
        $foodRepository = $this->getMockBuilder(\Hulk\HofexpressApp\Domain\Repository\FoodRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
