...
{
    /**
     * @var \Hulk\Hofexpress\Controller\OrderController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Hulk\Hofexpress\Controller\OrderController::class)
    ...
    {
        $order = new \Hulk\Hofexpress\Domain\Model\Order();
