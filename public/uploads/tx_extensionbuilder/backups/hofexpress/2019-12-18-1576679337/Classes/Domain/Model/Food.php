...
class Food extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
     ...
     * restaurant
     * 
     * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Hulk\Hofexpress\Domain\Model\Restaurant>
     */
    ...
    protected function initStorageObjects()
    {
        ...
        $this->restaurant = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
    }
     ...
     * @return void
     */
    public function addRestaurant(\Hulk\Hofexpress\Domain\Model\Restaurant $restaurant)
    {
        $this->restaurant->attach($restaurant);
    }

    /**
     * Removes a Restaurant
     * 
     * @param \Hulk\Hofexpress\Domain\Model\Restaurant $restaurantToRemove The Restaurant to be removed
     * @return void
     */
    public function removeRestaurant(\Hulk\Hofexpress\Domain\Model\Restaurant $restaurantToRemove)
    {
        $this->restaurant->detach($restaurantToRemove);
    }

    /**
     * Returns the restaurant
     * 
     * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Hulk\Hofexpress\Domain\Model\Restaurant> $restaurant
     */
     ...
     * Sets the restaurant
     * 
     * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\Hulk\Hofexpress\Domain\Model\Restaurant> $restaurant
     * @return void
     */
    public function setRestaurant(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $restaurant)
    {
