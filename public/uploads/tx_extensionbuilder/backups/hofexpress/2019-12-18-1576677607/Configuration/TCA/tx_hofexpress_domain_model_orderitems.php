...
return [
    ...
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, order_id, quantity, orders, food',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, order_id, quantity, orders, food, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'orders' => [
            'exclude' => true,
            'label' => 'LLL:EXT:hofexpress/Resources/Private/Language/locallang_db.xlf:tx_hofexpress_domain_model_orderitems.orders',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
