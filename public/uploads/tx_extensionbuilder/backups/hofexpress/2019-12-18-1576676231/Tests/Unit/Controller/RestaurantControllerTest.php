...
{
    /**
     * @var \Hulk\Hofexpress\Controller\RestaurantController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\Hulk\Hofexpress\Controller\RestaurantController::class)
    ...
    public function listActionFetchesAllRestaurantsFromRepositoryAndAssignsThemToView()
    {
        ...
        $restaurantRepository = $this->getMockBuilder(\Hulk\Hofexpress\Domain\Repository\RestaurantRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
